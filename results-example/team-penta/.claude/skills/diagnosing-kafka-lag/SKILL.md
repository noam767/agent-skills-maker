...
description: Use this skill when consumers report lag, the lag-alert fires, or downstream services see stale data. Walks the standard Kafka consumer-lag triage on Penta — group inspection, broker health correlation, then the Strimzi CR path for sustained fixes.
---
