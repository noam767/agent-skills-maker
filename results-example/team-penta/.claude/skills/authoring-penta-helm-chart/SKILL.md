---
name: authoring-penta-helm-chart
description: Use this skill when scaffolding a new Helm chart for the penta/charts monorepo. Triggers include "new chart for X", "Helm chart for service Y", "scaffold a deployment". Produces a chart that uses the penta-service library chart, pins images by digest, follows per-env values layout, and passes the conftest policy gates.
---
