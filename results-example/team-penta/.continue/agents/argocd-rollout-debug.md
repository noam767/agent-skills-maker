---
name: argocd-rollout-debug
description: "Specialist for ArgoCD sync failures and rollout issues on Penta — OutOfSync apps, comparison errors, stuck Progressing state, post-sync hook failures. Use whenever a Penta deployment isn't reaching the cluster as expected."
---
# Purpose
